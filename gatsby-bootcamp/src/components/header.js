...
const Header = () => {
    return (
        <header className={headerStyle.header}>
            <h1>
                <Link className={headerStyle.title} to="/">Weijing Huang</Link>
            </h1>
            <nav>
                <ul className={headerStyle.navList}>
                    ...
                    <li><Link className={headerStyle.navItem} activeClassName={headerStyle.activeNavItem} to="/about">About Me</Link></li>
